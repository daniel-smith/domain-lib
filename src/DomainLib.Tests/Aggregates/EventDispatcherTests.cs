...
namespace DomainLib.Tests.Aggregates
{
    ...
    public class EventDispatcherTests
    {
        ...
        public void EventIsRoutedAndApplied()
        {
            ...
            // Route the events.
            var newState = registry.EventDispatcher.Dispatch(initialState, event1, event2);
        ...
        public void MissingEventRouteThrowsException()
        {
            ...
            // Route the events.
            var exception = Assert.Throws<InvalidOperationException>(() => registry.EventDispatcher.Dispatch(initialState, event1, event2));
